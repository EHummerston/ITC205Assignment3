...
public class RestrictedPanel extends ABorrowPanel {
	...
	setLayout(null);
	setBorder(new TitledBorder(null, "Scanning", TitledBorder.LEADING,
		TitledBorder.TOP, null, null));
	setBounds(12, 23, 460, 640);
	// imported from elsewhere
	JPanel panel_2 = new JPanel();
	panel_2.setBorder(new TitledBorder(null, "Current Loan",
	...
	panel_4.setBorder(new TitledBorder(UIManager
		.getBorder("TitledBorder.border"), "Pending Loan List",
		TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	panel_5.setBorder(new TitledBorder(null, "Current Book",
		TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	panel_3.setBorder(new TitledBorder(null, "Borrower Details",
		TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	panel_6.setBorder(new TitledBorder(null, "Existing Loans",
		TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	panel_7.setBorder(new TitledBorder(null, "Borrowing Restrictions",
		TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	lblLoanLimit
		.setText("Borrower has reached maximum number of borrowed items");
    }

    @Override
    public void displayOutstandingFineMessage(float amountOwing) {
	lblFineLimit.setText(String.format(
		"Borrower has outstanding fines. Amount owing: $%.2f",
		amountOwing));
    }
	...
	lblFineLimit.setText(String.format(
		"Borrower has exceeded fine limit. Amount owing: $%.2f",
		amountOwing));
    }
